...
# Part One: Visualising and Analysing Time-oriented Data

# 6.1 Learning Outcome

Upon completing this practical exercise, we will have gained the ability to create the following data visualisations using R packages:

-   Create a calendar heatmap utilizing functions from the ggplot2 package
-   Generate a cycle plot with ggplot2 functions
-   Produce a slopegraph
-   Construct a horizon chart

# 6.2 Getting Started

Below is a code chunk to check, install and launch the following R packages: scales, viridis, lubridate, ggthemes, gridExtra, readxl, knitr, data.table and tidyverse.
...
## 6.4.4 Step 5: Computing year average arrivals by month
...
## 6.4.5 Srep 6: Plotting the cycle plot
...
## 6.5.2 Step 2: Plotting the slopegraph
