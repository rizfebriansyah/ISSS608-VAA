...
Upon completion of this hands on exercise, we will have developed the ability to:

-   Craft bullet charts utilising the ggplot2 package.
-   Generate sparklines using ggplot2.
-   Construct an industry-standard dashboard with the R Shiny framework.
