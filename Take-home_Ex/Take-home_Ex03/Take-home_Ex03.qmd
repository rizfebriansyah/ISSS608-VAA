...
Firstly, we need to import the 5 csv files using `read_csv`. I want to read and combine all the files as **feb_combined** since they all the files have the common column names and same number of columns.
```{r}
#| eval: false
# Read and combine in one step
feb_combined <- bind_rows(
  read.csv("data/CHANGI_FEB1983"),
  read.csv("data/CHANGI_FEB1993"),
  read.csv("data/CHANGI_FEB2003"),
  read.csv("data/CHANGI_FEB2013"),
  read.csv("data/CHANGI_FEB2023")
)
```
