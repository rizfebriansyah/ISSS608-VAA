...
pacman::p_load(ggiraph, plotly, 
               patchwork, DT, tidyverse, dplyr, ggplot, ggthemes) 
```
...
Since we are only focusing on temperature data, we will discard the columns related to rainfall and windspeed. Also, I will rename these columns below accordingly. Mean Temperature (°C) -\> meantemp Maximum Temperature (°C) -\> maxtemp Minimum Temperature (°C) -\> mintemp
